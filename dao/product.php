...
class Products
{
    ...
    public function insertProducts($category_id, $product_name, $product_desbribe, $price_sale, $product_thumbnail, $price, $created_at, $update_at, $product_views, $product_special)
    {
        $db = new connect();
        $query = 'INSERT INTO products (category_id, product_name, product_desbribe, price_sale, product_thumbnail, price, created_at, update_at, product_views, product_special) VALUES ( ?, ?, ?, ?, ?, ?, ?, ?, ?, ? )';
        $db->pdo_execute($query, $category_id, $product_name, $product_desbribe, $price_sale, $product_thumbnail, $price, $created_at, $update_at, $product_views, $product_special);
    }
