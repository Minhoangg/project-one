					...
					<div class="menu-desktop">
						<ul class="main-menu">
							...
							<li class="label1" data-label1="hot">
								<a href="layout.php?pages=shop">Features</a>
							</li>
				...
				<ul class="header-cart-wrapitem w-full">
					<li class="header-cart-item flex-w flex-t m-b-12">
						<div class="header-cart-item-img">
							<img src="../content/contentCilent/images/item-cart-01.jpg" alt="IMG">
						</div>
					...
					<li class="header-cart-item flex-w flex-t m-b-12">
						<div class="header-cart-item-img">
							<img src="../content/contentCilent/images/item-cart-02.jpg" alt="IMG">
						</div>
					...
					<li class="header-cart-item flex-w flex-t m-b-12">
						<div class="header-cart-item-img">
							<img src="../content/contentCilent/images/item-cart-03.jpg" alt="IMG">
						</div>
