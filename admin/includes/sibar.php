	...
	<div class="sidebar-inner slimscroll">
		<div id="sidebar-menu" class="sidebar-menu">
			<ul>
				...
				<li class="submenu"> <a href="#"><i class="fa-solid fa-users-line"></i><span>Khách Hàng</span> <span class="menu-arrow"></span></a>
					<ul class="submenu_class" style="display: none;">
						<li><a href="index.php?pages=user&action=list"> Danh Sách Khách Hàng</a></li>
						<li><a href="index.php?pages=user&action=edit"> Sửa Danh Sách Khách Hàng</a></li>
						<li><a href="index.php?pages=user&action=add"> Thêm Danh Sách Khách Hàng </a></li>
					</ul>
				</li>

				<li class="submenu"> <a href="#"><i class="fa fa-comments"></i> <span> Bình Luận</span> <span class="menu-arrow"></span></a>
					<ul class="submenu_class" style="display: none;">
						<li><a href="index.php?pages=comments&action=list"> Danh Sách Bình Luận</a></li>
						<li><a href="index.php?pages=comments&action=detail"> Bình Luận Chi Tiết</a></li>
					</ul>
				</li>

				<li class="submenu"> <a href="#"><i class="fa fa-cubes"></i> <span> Thống Kê</span> <span class="menu-arrow"></span></a>
					<ul class="submenu_class" style="display: none;">
						<li><a href="index.php?pages=statis&action=chart"> Thống Kê</a></li>
						<li><a href="index.php?pages=statis&action=statistical"> Biểu Đồ</a></li>
					</ul>
				</li>
