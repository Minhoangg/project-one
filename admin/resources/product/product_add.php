...
if (isset($_POST['btn_insert'])) {
    ...
    $product_views = ($_POST['so_luot_xem']);
    ...
    if (empty($price)) {
        ...
        $loiGia = 'Đơn giá phải là một số';
    }

    if (!isset($loiMa) && !isset($loiTen) && !isset($loiLoai) && !isset($loiMoTa) && !isset($loiGia) && !isset($loiSale) && !isset($loiNgay) && !isset($loiHinh)) {
        $create->insertProducts($category_id, $product_name, $product_desbribe, $price_sale, $product_thumbnail, $price, $created_at, $update_at, $product_views, $product_special);
    ...
    <div class="container">
        <div class="row col-11 mt-5 m-auto">
            <div class="card col-12">
                <div class="card-header text-center bg-dark  text-white text-uppercase">Thêm Sản Phẩm</div>
                <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-sm-4">
                                    ...
                                    <p id="hinh_error" style="color: red;">
