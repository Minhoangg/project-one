            ...
            <form action="?btn_delete_all" method="post" class="table-responsive">
                ...
                <table  class="table table-hover table-bordered text-center ">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="m-3">
                                <a href="index.php?pages=category&action=edit&id=<?= $lh['id'] ?>" class="btn btn-primary">Sửa</a>

                                <a href="index.php?pages=category&action=delete&id=<?= $lh['id'] ?>"  class="btn btn-danger">Xóa</a>
                            </div>
                        </td>
